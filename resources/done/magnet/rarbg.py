...
class source:
	...
	def __init__(self):
		...
		self.priority = 0
		self.language = ['un']
		self.domains = ['rarbgunblock.com', 'rarbg.unblocked.cool', 'rarbg.immunicity.cool', 'rarbg.bypassed.cool', 'rarbg.bypassed.cool']
		self.base_link = 'https://rarbgunblock.com'
		...
		self.torrent_link = 'https://rarbgunblock.com/download.php?id=%s&f=%s.torrent'
